    ...
    public static function render_admin_page() {
        ...
        <div class="wrap">
            ...
            <?php if ( get_option( 'wbv_use_action_scheduler', true ) && ! ( function_exists( 'as_enqueue_async_action' ) || function_exists( 'as_schedule_single_action' ) ) ) : ?>
                <div class="notice notice-warning inline"><p><?php echo esc_html__( 'ActionScheduler is not available. Background processing of large jobs will be disabled. Ensure WooCommerce (which includes ActionScheduler) is active or disable background processing in the settings.', 'woo-bulk-variation-pricer' ); ?></p></div>
            <?php endif; ?>
